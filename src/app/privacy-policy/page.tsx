    ...
    <section className="dark:bg-background">
      <div className="wrapper max-w-[1100px]">
        <div className="text-grey-soft flex flex-col rounded-md bg-slate-200 p-8 shadow-sm dark:bg-default dark:text-white [&>p]:mb-2">
          ...
          <h2 className="h4 mb-2">Interpretation and Definitions</h2>
          <h3 className="h5 mb-2">Interpretation</h3>
          <p>
          ...
          <h3 className="h5 mb-2">Definitions</h3>
          ...
          <ul className="[&>li]:mb-2">
            ...
            <li>
              ...
              in this Agreement) refers to Subscription Manager.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to Subscription Manager,
              accessible from https://www.subscription-manager.app/
            </li>
            <li>
          ...
          <h2 className="h4 mb-2">Collecting and Using Your Personal Data</h2>
          <h3 className="h5 mb-2">Types of Data Collected:</h3>
          <h4 className="h5 mb-2">Personal Data</h4>
          <p>
          ...
          <h4 className="h5 mb-2">Usage Data</h4>
          ...
          <h4 className="h5 mb-2">Tracking Technologies and Cookies</h4>
          <p>
          ...
          <p>
            ...
            cookies here: Cookies by TermsFeed Generator.
          </p>
          <p>
            We use both Session and Persistent Cookies for the purposes set out
            below:
          </p>
          <h4 className="h5 mb-2">Necessary / Essential Cookies</h4>
          ...
          <h4 className="h5 mb-2">Functionality Cookies</h4>
          <p>Type: Persistent Cookies</p>
          <p>Administered by: Us</p>
          <p>
          ...
          <h2 className="h4 mb-2">Use of Your Personal Data</h2>
          ...
          <h2 className="h4 mb-2">Retention of Your Personal Data</h2>
          <p>
          ...
          <h2 className="h4 mb-2">Transfer of Your Personal Data</h2>
          <p>
          ...
          <h2 className="h4 mb-2">Disclosure of Your Personal Data</h2>
          <h3 className="h5 mb-2">Business Transactions</h3>
          <p>
          ...
          <h3 className="h5 mb-2">Law enforcement</h3>
          <p>
          ...
          <h3 className="h5 mb-2">Other legal requirements</h3>
          <p>
          ...
          <h3 className="h5 mb-2">Security of Your Personal Data</h3>
          <p>
          ...
          <h2 className="h4 mb-2">Children&apos;s Privacy</h2>
          <p>
          ...
          <h2 className="h4 mb-2">Links to Other Websites</h2>
          <p>
          ...
          <h2 className="h4 mb-2">Changes to this Privacy Policy</h2>
          <p>
          ...
          <ul className="[&>li]:mb-2">
            <li>By email: scrumbuiss@gmail.com</li>
          </ul>
        </div>
      </div>
    </section>
